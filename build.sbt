...
name := "spark-cassandra-examples" // change to project name
organization := "org.anhtv08" // change to your org
...
libraryDependencies ++= Seq(
  ...
  // cassandra connector
  "com.datastax.spark" % "spark-cassandra-connector_2.11" % "2.4.1"  exclude("io.netty", "netty-all"),
...
mainClass in(Compile, packageBin) := Some("org.examples.datasets.FlightDataProcessor")
